...
import modules.tests.clusterability as clus
from modules.tests.hopkins import hopkins
...
def apply_proj(_wvs):
    RS = 17
    proj2 = TSNE(n_components=2, perplexity=30,
                 verbose=1,
                 n_iter=5000,
                 ...
                 min_grad_norm=1e-7,
                 random_state=RS)
    #proj2 = UMAP(n_components=2, optim_batch_size=100)
    down2 = proj2.fit_transform(_wvs)

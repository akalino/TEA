...
class TripleEmbedder(nn.Sequential):
    ...
    def fit(self,
        ...
        :param experiment_tracker: WandB tracker, if used.
        """
                ...
                for train_idx in range(num_train_objectives):
                    ...
                    if use_amp:
                        ...
                        if experiment_tracker is not None:
                            experiment_tracker.log({"Epoch": epoch,
                                                    "TrainingLoss": loss_value})
                        #if _s % 100 == 0:
                        #    print(loss_value)
                        loss_value.backward()
                        torch.nn.utils.clip_grad_norm_(loss_model.parameters(), max_grad_norm)
    ...
    def _load_auto_model(self, model_name_or_path):
        ...
        """
        logging.warning("No sentence-transformers model found with name {}. "

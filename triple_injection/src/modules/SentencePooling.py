...
class SentencePooling(nn.module):
    def __init__(self,
                 ...
                 _pooling_mode: str,
                 _pooling_mode_cls_token: bool = False,
                 _pooling_mode_max_tokens: bool = False,
                 _pooling_mode_mean_tokens: bool = True,
                 _pooling_mode_mean_sqrt_len_tokens: bool = False,
                 _pooling_mode_weightedmean_tokens: bool = False,
                 _pooling_mode_lasttoken: bool = False,
                 ):
        super(SentencePooling, self).__init__()
        if _pooling_mode is not None:  # Set pooling mode by string
            pooling_mode = _pooling_mode.lower()
        ...
        self.pooling_mode_cls_token = _pooling_mode_cls_token
        self.pooling_mode_mean_tokens = _pooling_mode_mean_tokens
        self.pooling_mode_max_tokens = _pooling_mode_max_tokens
        self.pooling_mode_mean_sqrt_len_tokens = _pooling_mode_mean_sqrt_len_tokens
        self.pooling_mode_weightedmean_tokens = _pooling_mode_weightedmean_tokens
        self.pooling_mode_lasttoken = _pooling_mode_lasttoken
